...
class DataSekolahPage extends StatefulWidget {
  ...
  const DataSekolahPage({super.key, this.isEmbedded = false, this.onNavigate});
...
class _DataSekolahPageState extends State<DataSekolahPage> {
  ...
  void _setupRealtimeData() {
    _schoolSubscription = supabase
      ...
      if (mounted) {
        setState(() {
          if (data.isNotEmpty) {
            // Urutkan berdasarkan ID terbesar agar data terbaru yang muncul
      ...
      debugPrint('Error realtime school data: $e');
  ...
  Widget build(BuildContext context) {
    bool canEdit = (_userRole == 'Admin' || _userRole == 'Guru' || _userRole == 'Super Admin');
          ...
          ? FloatingActionButton.extended(
              onPressed: () async {
                if (widget.isEmbedded && widget.onNavigate != null) {
                  ...
                  if (res == true) _setupRealtimeData();
                }
              },
      ...
      child: Column(
        ...
        children: [
          ...
          _buildModernCard([
            ...
            _buildModernRow(Icons.auto_stories_outlined, 'Kurikulum Utama', _schoolData!['curriculum']),
          ]),
          ...
          _buildModernCard([
            ...
            _buildModernRow(Icons.badge_outlined, 'NIP / NIY', _schoolData!['headmaster_nip']),
          ]),
          ...
          _buildModernCard([
            ...
            _buildModernRow(Icons.public_rounded, 'Situs Web', _schoolData!['website'], onTap: () => _launchUrl(_schoolData!['website'])),
          ]),
          
          const SizedBox(height: 24),
          _buildSectionLabel('LOKASI OPERASIONAL'),
          _buildModernCard([
            _buildModernRow(Icons.location_on_outlined, 'Alamat Lengkap', _schoolData!['address']),
          ]),
